...
files:
  ...
  runpomXXX: the compiling file used to call the model in the Cygwin Terminal. The name in the compiler should be exactly the same with the mymodelXXX file name
...
Step2: run the model using the exact file name
